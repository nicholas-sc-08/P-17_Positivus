...
function Faq_quatro() {
  ...
  return (
    <div className='container_espaco_faq_quatro' style={{ height: altura_div }}>

      <article className="container_faq_quatro">

        <header className="container_titulo_faq_quatro" style={{ height: altura_titulo }}>

          <h3><span>04</span>Monitoring and Optimization</h3>
