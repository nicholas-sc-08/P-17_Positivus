...
function Faq_tres() {
  ...
  return (
    <div className='container_espaco_faq_tres' style={{ height: altura_div }}>

      <article className="container_faq_tres">

        <header className="container_titulo_faq_tres" style={{ height: altura_titulo }}>
