...
function Faq_cinco() {
  ...
  return (
    <div className='container_espaco_faq_cinco' style={{ height: altura_div }}>

      <article className="container_faq_cinco">

        <header className="container_titulo_faq_cinco" style={{ height: altura_titulo }}>

          <h3><span>05</span>Reporting and Communication</h3>
