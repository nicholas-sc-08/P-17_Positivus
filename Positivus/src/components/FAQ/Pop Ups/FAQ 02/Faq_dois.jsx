...
function Faq_dois() {
  ...
  return (
    <div className='container_espaco_faq_dois' style={{ height: altura_div }}>

      <article className="container_faq_dois">

        <header className="container_titulo_faq_dois" style={{ height: altura_titulo }}>

          <h3><span>02</span>Research and Strategy Development</h3>
